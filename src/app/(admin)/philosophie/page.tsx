...
import { PhilosophieCanvas } from '@/components/editor/PhilosophieCanvas'
import type { BothLangs } from '@/types/content'

export default async function PhilosopiePage() {
  ...
  return <PhilosophieCanvas initialContent={initialContent} />
}
